			...
			<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					...
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<li class="breadcrumb-item text-muted">Edit Berita Adiwiyata</li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="card mb-5 mb-xl-10">
							<div class="card-header pt-2 mb-5">
								<div class="card-title d-flex flex-column">
									<span class="text-uppercase fw-bold pb-0 fs-3">Edit Berita yang sudah
										dipublikasi</span>
								</div>
								<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
									<a class="btn btn-light-primary" href="<?= BASEURL; ?>AdminAdiwiyataBerita">
							...
							<div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
								<div class="d-flex flex-column content-justify-center flex-row-fluid">
									<form action="<?= BASEURL; ?>AdiwiyataBeritaEdit/ubah/<?= $data['isiberita']['id'] ?>" method="post" enctype="multipart/form-data">
									<input type="hidden" name="fotoLama" id="fotoLama" value="<?= $data['isiberita']['foto'] ?>">
									<input type="hidden" name="id" id="id" value="<?= $data['isiberita']['id'] ?>">
										<div class="row mb-5 fv-row">
											<label for="judul" class="col-sm-2 col-form-label">Judul Berita</label>
											<div class="col-sm-10">
												<input type="text" class="form-control" id="judul" name="judul"
													value="<?= $data['isiberita']['judul'] ?>">
											</div>
										</div>
										<div class="row mb-5 fv-row">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="author" name="author"
													value="<?= $data['isiberita']['author'] ?>">
											</div>
										</div>
										<div class="row mb-5 fv-row">
											<label for="author" class="col-sm-2 col-form-label">Tanggal Publikasi</label>
											<div class="col-sm-10">
												<input type="text" class="form-control" id="tanggal_publikasi" name="tanggal_publikasi"
													value="<?= $data['isiberita']['tanggal_publikasi'] ?>">
											</div>
										</div>
												...
												<div class="row row-editor">
													<div class="editor-container">
														<textarea class="editor"
															name="isi"><?= $data['isiberita']['isi'] ?></textarea>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-sm-10">
												<div class="overlay my-2">
													<img id="selectedImage" class="w-100 card-rounded"
														src="<?= $data['isiberita']['foto'] ?>" alt="" />
													<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
														<input type="file" id="fileInput" name="foto" accept=".jpg" style="display: none;" onchange="previewImage(event)">
							...
							<div class="card-footer">
								<button class="btn btn-primary float-end" type="submit">Edit Berita Adiwiyata</button>
								</form>
							</div>
						</div>
					</div>
