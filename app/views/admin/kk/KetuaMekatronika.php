...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
			...
			<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					...
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<li class="breadcrumb-item text-muted">Ketua Jurusan Mekatronika</li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="card mb-5 mb-xl-10">
							<div class="card-header pt-2 mb-5">
								<div class="card-title d-flex flex-column">
									<span class="text-uppercase fw-bold pb-0 fs-3">Perbarui Ketua Jurusan Mekatronika</span>
								</div>
							</div>
							<div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
								<div class="d-flex flex-column content-justify-center flex-row-fluid">
									<form id="kt_docs_formvalidation" class="form"
										action="<?= BASEURL; ?>AdminKetuaMekatronika/tambah" method="POST"
										...
										<div class="row mb-5 fv-row">
											...
											<div class="col-sm-10">
												<input class="form-control" id="jabatan" name="jabatan"
													placeholder="Ketua Jurusan Mekatronika"></input>
											</div>
										</div>
    ...
    $('[data-kt-permissions-table-filter="delete_row"]').on('click', function (e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                const deleteUrl = "<?= BASEURL; ?>AdminKetuaMekatronika/hapus/<?= $KetuaMeka['id'] ?>";
