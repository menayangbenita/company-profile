			...
			<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					...
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<li class="breadcrumb-item text-muted">Enetrotika</li>
					</ul>
				</div>
			</div>
		</div>
							...
							<div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
								<div class="d-flex flex-column content-justify-center flex-row-fluid">
									<form id="kt_docs_formvalidation" class="form"
										action="<?= BASEURL; ?>AdminEnetrotika/tambah" method="post" autocomplete="off">
												...
												<?php foreach ($data['dpk'] as $dpk): ?>
													<tr>
														...
														<td class="text-center text-nowrap">
															<a href="<?= BASEURL; ?>AdminEnetrotika/ubahDpk/<?= $dpk['id'] ?>"
																data-id="<?= $dpk['id']; ?>"
															...
															<a href="<?= BASEURL; ?>AdminEnetrotika/hapusDpk/<?= $dpk['id'] ?>"
											...
											<tbody class="fw-semibold text-gray-700">
												...
												<?php foreach ($data['kk'] as $kk): ?>
													<tr>
														...
														<td class="text-center text-nowrap">
															<a href="<?= BASEURL; ?>AdminEnetrotika/ubahKk/<?= $kk['id'] ?>"
																data-id="<?= $kk['id']; ?>"
															...
															<a href="<?= BASEURL; ?>AdminEnetrotika/hapusKk/<?= $kk['id'] ?>"
																class="btn btn-icon btn btn-outline btn-outline-danger btn-active-light-danger btn-sm"
																data-bs-toggle="tooltip" data-bs-placement="bottom"
																title="Hapus">
																<i class="ki-duotone ki-trash fs-2">
	...
	<div class="modal fade" tabindex="-1" id="modalTambah">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<form id="kt_docs_formvalidation" class="form" action="<?= BASEURL; ?>AdminEnetrotika/tambahKk"
