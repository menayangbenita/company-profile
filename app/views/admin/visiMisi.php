                                            ...
                                            <?php foreach ($data['misi'] as $misi) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center text-nowrap">
														<a href="<?= BASEURL; ?>AdminVisiMisi/ubahMisi/<?= $misi['id'] ?>"
                                                            data-id="<?= $misi['id']; ?>"
                                                        ...
                                                        <a href="<?= BASEURL; ?>AdminVisiMisi/hapusMisi/<?= $misi['id'] ?>"
...
<div class="modal fade" tabindex="-1" id="modalTambah">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="kt_docs_formvalidation" class="form" action="<?= BASEURL; ?>AdminVisiMisi/tambahMisi" method="post" enctype="multipart/form-data" autocomplete="off">
