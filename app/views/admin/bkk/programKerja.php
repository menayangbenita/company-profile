							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Program Kerja BKK</h1>
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<li class="breadcrumb-item text-muted">Program Kerja BKK</li>
										</ul>
									</div>
								</div>
							</div>
											...
											<div class="card mb-5 mb-xl-10">
												<div class="card-header pt-2 mb-5">
													<div class="card-title d-flex flex-column">
														<span class="text-uppercase fw-bold pb-0 fs-3">Perbarui Program Kerja BKK</span>
													</div>
												</div>
													...
													<div class="d-flex flex-column content-justify-center flex-row-fluid">
														<form id="kt_docs_formvalidation" class="form" action="#" autocomplete="off">
															<div class="row mb-5 fv-row">
																<label for="teksprogrambkk" class="col-sm-2 col-form-label required">Teks</label>
																<div class="col-sm-10">
																	<input type="text" class="form-control" id="teksprogrambkk"  name="teksprogrambkk"  value="Lorem ipsum dolor sit amet consectetur, adipisicing elit :">
																</div>
															</div>
															<div class="row mb-5 fv-row">
																<label for="linkgdriveprogrambkk" class="col-sm-2 col-form-label required">Link Google Drive</label>
																<div class="col-sm-10">
																	<input type="url" class="form-control" id="linkgdriveprogrambkk" name="linkgdriveprogrambkk" value="Sed vestibulum ante quis justo accumsan, vel congue justo vehicula">
