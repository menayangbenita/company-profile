				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					...
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						<li class="breadcrumb-item text-muted">
							<a href="index.html" class="text-muted text-hover-primary">Visi Misi BKK</a>
						</li>
							...
							<div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
								<div class="d-flex flex-column content-justify-center flex-row-fluid">
									<form id="kt_docs_formvalidation" class="form"
										action="<?= BASEURL; ?>BkkvisiMisi/tambah" method="post" autocomplete="off">
                                            ...
                                            <?php foreach ($data['misi'] as $misi) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center text-nowrap">
														<a href="<?= BASEURL; ?>BkkvisiMisi/ubahMisi/<?= $misi['id'] ?>"
                                                            data-id="<?= $misi['id']; ?>"
                                                        ...
                                                        <a href="<?= BASEURL; ?>BkkvisiMisi/hapusMisi/<?= $misi['id'] ?>"
...
<div class="modal fade" tabindex="-1" id="modalTambah">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="kt_docs_formvalidation" class="form" action="<?= BASEURL; ?>BkkvisiMisi/tambahMisi" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    $(document).ready(function () {
        $('[data-kt-permissions-table-filter="delete_row"]').on('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    const deleteUrl = "<?= BASEURL; ?>BkkvisiMisi/hapusMisi/" + itemId;
