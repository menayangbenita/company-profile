                    ...
                    <div class="col-xxl-12">
                        ...
                        <div class="card mb-5 mb-xl-10">
                            <div class="card-header pt-2 mb-5">
                                <div class="card-title d-flex flex-column">
                                    <div class="card-title d-flex flex-column">
                                        <span class="text-uppercase fw-bold pb-0 fs-3">Unggah Gambar galeri
                                            organisasi</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered align-middle" id="table">
                                            ...
                                            <tbody class="fw-semibold text-gray-700">
                                                <?php foreach ($data['organisasi'] as $organisasi): ?>
                                                    <tr>
                                                        <td style="display: none;">
                                                            <span class="orgnanisasi-id">
                                                                <?= $orgnanisasi['id']; ?>
                                                            </span>
                                                        </td>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="">
                                                                    ...
                                                                    <a class="d-block overlay"
                                                                        ...
                                                                        href="<?= BASEURL; ?>img/datafoto/<?= $organisasi['foto']; ?>">
                                                                        <!--begin::Image-->
                                                                        <div class="symbol symbol-50px">
                                                                            <img
                                                                                src="<?= BASEURL; ?>img/datafoto/<?= $organisasi['foto']; ?>">
                                                                        </div>
                                                                        <!--end::Image-->
                                                        ...
                                                        <td class="text-center text-nowrap">
                                                            <a href="<?= BASEURL; ?>AdminOrganisasi/ubah/<?= $organisasi['id'] ?>"
                                                                data-id="<?= $organisasi['id']; ?>" type="button"
                                                            ...
                                                            <a href="<?= BASEURL; ?>AdminOrganisasi/hapus/<?= $organisasi['id'] ?>"
    ...
    <div class="modal fade" tabindex="-1" id="modalTambah">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="kt_docs_formvalidation" class="form" action="<?= BASEURL; ?>AdminOrganisasi/tambah"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="row mb-3 fv-row">
                                    <label for="galeriorganisasi"
                                        class="col-sm-2 col-form-label required">Gambar</label>
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" accept=".jpeg , .jpg, .png"
                                            id="galeriorganisasi" name="foto">
