			...
			<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					...
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<li class="breadcrumb-item text-muted">Organisasi Kesiswaan</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
						...
						<div class="card mb-5 mb-xl-10">
							<div class="card-header pt-2 mb-5">
								<div class="card-title d-flex flex-column">
									<span class="text-uppercase fw-bold pb-0 fs-3">Tulis tentang Gerakan Organisasi Kesiswaan</span>
								</div>
							</div>
							<div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
								<div class="d-flex flex-column content-justify-center flex-row-fluid">
                                <form class="form" action="<?= BASEURL; ?>AdminOrganisasi/tambahIsi" method="post" 									<div class="row" data-bs-theme="light">
                                            <div class="col-sm-12">
                                                <div class="row">
                    ...
                    <div class="card mb-5 mb-xl-10">
                        <div class="card-header pt-2 mb-5">
                            <div class="card-title d-flex flex-column">
                                <div class="card-title d-flex flex-column">
                                    <span class="text-uppercase fw-bold pb-0 fs-3">Unggah Gambar Dokumentasi Organisasi</span>
                                </div>
                            </div>
                                        ...
                                        <tbody class="fw-semibold text-gray-700">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-nowrap">
                                                    <a href="<?= BASEURL; ?>AdminOrganisasi/hapusGaleri/<?= $galeri['id'] ?>"
...
<div class="modal fade" tabindex="-1" id="modalTambah">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="kt_docs_formvalidation" class="form" action="<?= BASEURL; ?>AdminOrganisasi/tambahGaleri" method="post" enctype="multipart/form-data" autocomplete="off">
