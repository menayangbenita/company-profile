                        ...
                        <div class="card mb-5 mb-xl-10">
                            <div class="card-header pt-2 mb-5">
                                <div class="card-title d-flex flex-column">
                                    <span class="text-uppercase fw-bold pb-0 fs-3">Tulis tentang Gerakan Organisasi
                                        Kesiswaan</span>
                                </div>
                            </div>
                            <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                                <form class="form" action="<?= BASEURL; ?>AdminOrganisasi/tambahIsi" method="post">
    ...
    <div class="modal fade" tabindex="-1" id="modalTambah">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="kt_docs_formvalidation" class="form" action="<?= BASEURL; ?>AdminOrganisasi/tambahGaleri"
