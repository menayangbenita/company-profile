					...
					<div class="col-xxl-12">
						<div class="card mb-5 mb-xl-10">
							...
							<div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                                ...
                                <form class="form" action="<?= BASEURL; ?>EkstrakurikulerDokumentasi/tambahIsi" method="post" 									<div class="row" data-bs-theme="light">
                                        ...
                                        <tbody class="fw-semibold text-gray-700">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-nowrap">
                                                    <a href="<?= BASEURL; ?>EkstrakurikulerDokumentasi/hapusGaleri/<?= $galeri['id'] ?>"
...
<div class="modal fade" tabindex="-1" id="modalTambah">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="kt_docs_formvalidation" class="form" action="<?= BASEURL; ?>EkstrakurikulerDokumentasi/tambahGaleri" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    $(document).ready(function () {
        $('[data-kt-permissions-table-filter="delete_row"]').on('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    const deleteUrl = "<?= BASEURL; ?>EkstrakurikulerDokumentasi/hapusIndus/" + itemId;
