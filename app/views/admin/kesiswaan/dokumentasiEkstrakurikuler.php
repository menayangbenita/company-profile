                    ...
                    <div class="col-xxl-12">
                        <div class="card mb-5 mb-xl-10">
                            ...
                            <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                                <form class="form" action="<?= BASEURL; ?>EkstrakurikulerDokumentasi/tambahIsi"
                                    method="post" <div class="row" data-bs-theme="light">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="kt_docs_formvalidation" class="form"
                    action="<?= BASEURL; ?>EkstrakurikulerDokumentasi/tambahGaleri" method="post"
