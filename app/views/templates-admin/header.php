				...
				<div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
					...
					<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
						<a href="<?= BASEURL; ?>admin/dist/index.html" class="d-lg-none">
							<img alt="Logo" src="<?= BASEURL; ?>admin/media/logo_smk8-removebg-preview.png"
								class="h-30px" />
						</a>
					</div>
									...
									<div class="row g-0">
										...
										<div class="col-6">
											<a href="<?= BASEURL; ?>AdminFaq"
												...
												<span class="fs-7 text-gray-400 text-center">Perbarui pertanyaan yang
													sering diajukan</span>
											</a>
										</div>
										<div class="col-6">
											<a href="<?= BASEURL; ?>AdminFooter"
				...
				<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
					...
					<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
						<a href="<?= BASEURL; ?>admin/dist/index.html">
							<img alt="Logo" src="<?= BASEURL; ?>admin/media/logolightfix.png"
								class="h-30px app-sidebar-logo-default theme-light-show" />
							<img alt="Logo" src="<?= BASEURL; ?>admin/media/logodarkfix.png"
